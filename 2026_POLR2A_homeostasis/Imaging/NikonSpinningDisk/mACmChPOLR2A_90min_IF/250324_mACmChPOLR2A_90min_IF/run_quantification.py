...
def process_single_site(input_file,input_dir,label_image_dir,features_dir,illumcorr_file):
    ...
    intensity_image_corrected.save(label_image_dir / Path("corrected_" + Path(input_file).name))

    # segment DAPI channel (3)
...
if __name__ == "__main__":
    ...
    process_single_site(input_file,input_dir,output_dir,features_dir,illumcorr_file)
